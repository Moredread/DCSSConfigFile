...
function HDAtravel()
    ...
    local gourmand_and_hungry = you_are_gourmand() and not (you_are_engorged() or you_are_ghoul)
    ...
    local you_want_spare_chunks = (not (have_spare_chunks or you_do_not_eat)) and (true or can_cast_regen or you_have_staff_of_energy or you_are_sif)
